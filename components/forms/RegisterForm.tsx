        ...
        <>
            <View style={styles.formContainer}>
                <BasicInput
                    ...
                    onSubmitEditing={() => setFocus("fullName")}
                    returnKeyType="next"
                ...
                <BasicInput
                    ...
                    rules={{ required: "Password tidak boleh kosong.", minLength: { value: 8, message: "Password tidak boleh kurang dari 8 karakter." } }}
                    submitBehavior="submit"
                ...
                <BasicInput
                    ...
                    rules={{
                        ...
                        validate: {
                            CheckPass: (value) => {
                                return value === password || "Konfirmasi password tidak sama dengan password.";
                            },
                        },
                    }}
                />
